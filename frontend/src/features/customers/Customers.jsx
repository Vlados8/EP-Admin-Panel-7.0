                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <span>
                                                {formData.type === 'private' ? 'Privatperson' : 'Firma'}
                                            </span>
                                            <i className={`fa-solid fa-chevron-down text-gray-400 text-xs transition-transform duration-200 ${isTypeSelectOpen ? 'rotate-180' : ''}`}></i>
                                        </button>
                                        {isTypeSelectOpen && (
                                            <>
                                                <div className="fixed inset-0 z-40" onClick={() => setIsTypeSelectOpen(false)} />
                                                <div className="absolute left-0 right-0 mt-1 bg-[#121212]/95 border border-white/10 rounded-lg shadow-2xl z-50 py-1 backdrop-blur-md animate-[fadeIn_0.15s_ease-out] text-left">
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-4 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors ${formData.type === 'company' ? 'bg-white/5 text-blue-400 font-medium' : ''}`}
                                                    >
                                                        Firma
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-4 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors ${formData.type === 'private' ? 'bg-white/5 text-blue-400 font-medium' : ''}`}
                                                    >
                                                        Privatperson
                                                    </button>
                                                </div>
                                        ...
                                        >
                                            <span>
                                                {formData.status === 'active' ? 'Aktiv' : 
                                                 formData.status === 'lead' ? 'Interessent (Lead)' : 
                                                 formData.status === 'inactive' ? 'Inaktiv' : formData.status}
                                            </span>
                                            ...
                                            <>
                                                ...
                                                <div className="absolute left-0 right-0 mt-1 bg-[#121212]/95 border border-white/10 rounded-lg shadow-2xl z-50 py-1 backdrop-blur-md animate-[fadeIn_0.15s_ease-out] text-left">
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            setFormData({ ...formData, status: 'lead' });
                                                            setIsStatusSelectOpen(false);
                                                        }}
                                                        className={`w-full text-left px-4 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors ${formData.status === 'lead' ? 'bg-white/5 text-blue-400 font-medium' : ''}`}
                                                    >
                                                        Interessent (Lead)
                                                    </button>
                                                    <button
