...
app.use(helmet({
    ...
    contentSecurityPolicy: {
        directives: {
            ...
            "img-src": ["'self'", "data:", "http://localhost:3001", "http://localhost:3000", "https://ui-avatars.com", "https://*.empire-premium.de", "https://*.empire-premium-bau.de", "https://*.railway.app", "https://*.r2.dev", "https://*.cloudflarestorage.com"],
